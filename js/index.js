...
.then(function(data){
    ...
    for (let i=0; i< 5; i++){
        ...
        contenido+= `<article class="articulo">
                        <a href="./detalles_peliculas.html"> <img src="https://image.tmdb.org/t/p/w500${series[i].poster_path}"></a>
                        <a href="./detalles_peliculas.html?id=${series[i].id}">
                        </a>
                        <h3>${series[i].name}</h3>
...
.then(function(data){
    ...
    for (let i=0; i< 5; i++){
        ...
        contenido+= `<article class="articulo">
                        <a href="./detalles_peliculas.html"> <img src="https://image.tmdb.org/t/p/w500${peliculaPop[i].poster_path}"></a>
                        <a href="./detalles_peliculas.html?id=${peliculaPop[i].id}">
                        </a>
                        <h3>${peliculaPop[i].title}</h3>
